    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 mx-auto max-w-4xl px-6 pb-28 text-center">
                ...
                <h1 className="mb-5 font-heading text-3xl font-bold leading-tight text-white sm:mb-6 sm:text-5xl md:text-6xl lg:text-7xl" style={{ textShadow: '0 2px 4px rgba(0,0,0,0.2)' }}>
                    {t('hero.title')}{' '}
                    <span className="text-coral">{t('hero.titleHighlight')}</span>
                </h1>

                <p className="mx-auto mb-8 max-w-2xl text-base leading-relaxed text-white/90 sm:mb-10 sm:text-xl" style={{ textShadow: '0 1px 3px rgba(0,0,0,0.3)' }}>
                    {t('hero.subtitle')}
                </p>
                ...
                <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-center sm:gap-4">
                    <button
                        ...
                        className="rounded-full bg-coral px-6 py-3 text-sm font-semibold text-white shadow-2xl transition-all duration-200 hover:bg-coral-dark hover:shadow-3xl hover:-translate-y-0.5 sm:px-8 sm:py-4 sm:text-lg"
                    >
                        {t('hero.cta')}
                    </button>
                    <a
                        href="#gallery"
                        className="rounded-full border-2 border-white/60 px-6 py-3 text-sm font-semibold uppercase tracking-wider text-white backdrop-blur-sm transition-all duration-200 hover:border-white hover:bg-white/10 sm:px-8 sm:py-4 sm:text-lg"
                    >
                        {t('hero.explore')}
                    </a>
                </div>
                ...
                <a
                    ...
                    className="group mt-8 inline-flex flex-wrap items-center justify-center gap-2 rounded-full border border-white/15 bg-white/5 px-4 py-2 backdrop-blur-sm transition-all duration-200 hover:bg-white/10 hover:border-white/25 sm:mt-12 sm:gap-3 sm:px-5 sm:py-2.5"
                >
                    {/* Trustpilot Stars */}
                    ...
                    <div className="flex items-center gap-1.5">
                        <svg className="h-3.5 w-3.5 sm:h-4 sm:w-4" viewBox="0 0 24 24" fill="none">
                        ...
                        <span className="text-xs font-semibold text-white/90 sm:text-sm">Trustpilot</span>
                    </div>
                    <span className="text-xs text-white/60 sm:text-sm">5.0 · {t('hero.trust')}</span>
                </a>
            </div>
