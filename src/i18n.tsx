...
const translations = {
    en: {
        ...
        'discoverPage.beaches.s3Title': 'Playa de la Enramada',
        'discoverPage.beaches.s3Body': 'Just a 3-minute walk from the flat, this black volcanic sand beach stretches along the coast with stunning views of La Gomera. It\'s quieter than the resort beaches, making it perfect for relaxed mornings. The natural rock pools at the southern end are great for children.',
    ...
    cs: {
        ...
        'discoverPage.beaches.s3Title': 'Playa de la Enramada',
        'discoverPage.beaches.s3Body': 'Pouhé 3 minuty pěšky od apartmánu. Tato pláž s černým vulkanickým pískem se táhne podél pobřeží s úchvatnými výhledy na La Gomeru. Je klidnější než pláže resortů, ideální pro relaxační rána. Přírodní skalní jezírka na jižním konci jsou skvělá pro děti.',
        'discoverPage.beaches.s4Title': 'Playa del Duque',
