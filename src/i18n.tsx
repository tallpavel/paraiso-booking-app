...
const translations = {
    en: {
        ...
        'booking.lastMinuteNote': 'For bookings within 14 days of arrival, full payment is required upon confirmation instead of a deposit.',
        ...
        'terms.s3.p2': 'Payments are processed securely via Stripe. All bank fees are the responsibility of the Guest.',
        'terms.s3.p3': 'A cleaning fee may apply and will be communicated before confirmation. Tourist tax (Impuesto sobre estancias turísticas), if applicable, is included in the nightly rate.',
    ...
    es: {
        ...
        'booking.lastMinuteNote': 'Para reservas con menos de 14 días de antelación, se requiere el pago completo en lugar del depósito.',
        ...
        'terms.s3.p2': 'Los pagos se procesan de forma segura a través de Stripe. Los gastos bancarios corren a cargo del Huésped.',
        'terms.s3.p3': 'Puede aplicarse una tarifa de limpieza, que se comunicará antes de la confirmación. El impuesto turístico (Impuesto sobre estancias turísticas), si corresponde, está incluido en la tarifa por noche.',
    ...
    cs: {
        ...
        'booking.lastMinuteNote': 'U rezervací méně než 14 dní před příjezdem je vyžadována celá platba místo zálohy.',
        ...
        'terms.s3.p2': 'Platby jsou bezpečně zpracovávány přes Stripe. Bankovní poplatky hradí Host.',
        'terms.s3.p3': 'Může být účtován poplatek za úklid, který bude sdělen před potvrzením. Turistická daň, pokud se uplatňuje, je zahrnuta v ceně za noc.',
