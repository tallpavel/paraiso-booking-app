...
const translations = {
    en: {
        ...
        'terms.s3.li1': 'A 30% non-refundable deposit is due within 48 hours of booking confirmation to secure the reservation.',
        'terms.s3.li2': 'The remaining 70% balance is due no later than 14 days before the check-in date.',
        'terms.s3.li3': 'For bookings made less than 14 days before check-in, the full amount is due at the time of booking.',
        'terms.s3.p2': 'Payments can be made via bank transfer or other methods agreed upon with the owner. All bank fees are the responsibility of the Guest.',
        ...
        // S4 – Cancellation
        'terms.s4.title': 'Cancellation & Refunds',
        'terms.s4.p1': 'All cancellations must be communicated in writing (email). The following refund policy applies based on the notice period before the check-in date:',
        'terms.s4.tableWhen': 'Cancellation Notice',
        'terms.s4.tableRefund': 'Refund',
        'terms.s4.row1when': 'More than 30 days before check-in',
        'terms.s4.row1refund': '100% refund (minus deposit)',
        'terms.s4.row2when': '15–30 days before check-in',
        'terms.s4.row2refund': '50% refund (minus deposit)',
        'terms.s4.row3when': 'Less than 15 days before check-in',
        'terms.s4.row3refund': 'No refund',
        'terms.s4.p2': 'The 30% deposit is non-refundable in all cases. In the event of a no-show (failure to arrive without prior notice), no refund will be issued.',
        'terms.s4.p3': 'The owner may offer rebooking for alternative dates at their discretion, subject to availability. Date changes are treated as a cancellation of the original booking followed by a new reservation.',
    ...
    es: {
        ...
        'terms.s3.li1': 'Un depósito no reembolsable del 30% se debe pagar dentro de las 48 horas posteriores a la confirmación de la reserva.',
        'terms.s3.li2': 'El 70% restante se debe pagar no más tarde de 14 días antes de la fecha de entrada.',
        'terms.s3.li3': 'Para reservas realizadas con menos de 14 días de antelación, el importe total se debe pagar en el momento de la reserva.',
        'terms.s3.p2': 'Los pagos pueden realizarse mediante transferencia bancaria u otros métodos acordados con el propietario. Los gastos bancarios corren a cargo del Huésped.',
        ...
        'terms.s4.title': 'Cancelación y Reembolsos',
        'terms.s4.p1': 'Todas las cancelaciones deben comunicarse por escrito (email). Se aplica la siguiente política de reembolso según el plazo de aviso antes de la fecha de entrada:',
        'terms.s4.tableWhen': 'Aviso de Cancelación',
        'terms.s4.tableRefund': 'Reembolso',
        'terms.s4.row1when': 'Más de 30 días antes del check-in',
        'terms.s4.row1refund': '100% reembolso (menos depósito)',
        'terms.s4.row2when': '15–30 días antes del check-in',
        'terms.s4.row2refund': '50% reembolso (menos depósito)',
        'terms.s4.row3when': 'Menos de 15 días antes del check-in',
        'terms.s4.row3refund': 'Sin reembolso',
        'terms.s4.p2': 'El depósito del 30% no es reembolsable en ningún caso. En caso de no presentarse sin aviso previo, no se emitirá ningún reembolso.',
        'terms.s4.p3': 'El propietario puede ofrecer un cambio de fechas a su discreción, sujeto a disponibilidad. Los cambios de fecha se tratan como una cancelación de la reserva original seguida de una nueva reserva.',
    ...
    cs: {
        ...
        'terms.s3.li1': 'Nevratná záloha 30% je splatná do 48 hodin od potvrzení rezervace.',
        'terms.s3.li2': 'Zbývajících 70% je splatných nejpozději 14 dní před datem příjezdu.',
        'terms.s3.li3': 'U rezervací provedených méně než 14 dní před příjezdem je celá částka splatná v době rezervace.',
        'terms.s3.p2': 'Platby lze provést bankovním převodem nebo jinými dohodnutými způsoby. Bankovní poplatky hradí Host.',
        ...
        'terms.s4.title': 'Storno a vrácení peněz',
        'terms.s4.p1': 'Všechna storna musí být oznámena písemně (emailem). Platí následující pravidla pro vrácení peněz na základě doby oznámení před datem příjezdu:',
        'terms.s4.tableWhen': 'Oznámení o stornování',
        'terms.s4.tableRefund': 'Vrácení',
        'terms.s4.row1when': 'Více než 30 dní před příjezdem',
        'terms.s4.row1refund': '100% vrácení (mimo zálohu)',
        'terms.s4.row2when': '15–30 dní před příjezdem',
        'terms.s4.row2refund': '50% vrácení (mimo zálohu)',
        'terms.s4.row3when': 'Méně než 15 dní před příjezdem',
        'terms.s4.row3refund': 'Bez vrácení',
        'terms.s4.p2': 'Záloha 30% je nevratná ve všech případech. V případě nedostavení se bez předchozího oznámení nebude poskytnuto žádné vrácení.',
        'terms.s4.p3': 'Vlastník může nabídnout přerezervování na jiné termíny dle svého uvážení, s ohledem na dostupnost.',
