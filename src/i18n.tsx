...
const translations = {
    en: {
        ...
        'hero.title': 'Holiday Apartment with Ocean Views in',
        'hero.titleHighlight': 'Playa Paraíso',
        'hero.subtitle': 'Wake up to Atlantic sunsets, year-round sunshine, and the calm of southern Tenerife. Book directly with the owner\u00a0— save up to 15% on booking fees. No agency commissions, ever.',
        ...
        'amenity.parking': 'Public Parking',
        'amenity.parkingDesc': 'Free public street parking is available near the building.',
        ...
        'map.hint': '👆 Tap to explore on map',
        'map.explore': 'explore →',
        'map.spots': 'spots',
        'map.yourHome': 'Your holiday home',
        'map.walkPool': '🚶 1 min walk',
        'map.walkBeachGalgas': '🚶 3 min walk',
        'map.walkBeachAjabo': '🚶 8 min walk',
        'map.walkRestaurants': '🚶 1–5 min walk',
        'map.walkSupermarket': '🚶 1 min walk',
        'map.walkPharmacy': '🚶 3 min walk',
        'map.medical': 'Medical Center',
        'map.walkMedical': '🚶 5 min walk',
        'map.shopping': 'Shopping Center (Rosa)',
        'map.walkShopping': '🚶 5 min walk',
        'map.walkAirport': '🚗 20 min drive',
        'map.discoverBeach': 'Discover beach',
        ...
        'discoverPage.viewOnMap': 'View on map',
        ...
        'discoverPage.beaches.s1Title': 'Playa Las Galgas',
        'discoverPage.beaches.s1Body': 'Your closest beach — just a 3-minute walk from Verónica\'s Flat. This intimate volcanic cove is framed by dramatic dark rock formations and crystal-clear turquoise waters. A favourite among locals for its peaceful atmosphere and stunning Atlantic views. The rocky pools are perfect for snorkelling and the sunsets here are unforgettable.',
        'discoverPage.beaches.s2Title': 'Playa de Ajabo',
        'discoverPage.beaches.s2Body': 'A hidden gem 8 minutes on foot, this secluded black-sand cove is surrounded by lush tropical vegetation and volcanic cliffs. The calm, sheltered waters make it ideal for swimming and snorkelling. Rarely crowded even in high season — it feels like your own private beach.',
        'discoverPage.beaches.s3Title': 'Playa nudista de Diego Hernández',
        'discoverPage.beaches.s3Body': 'Accessible via a scenic hike, this hidden gem is famous for its crystal-clear turquoise waters and pristine white sand. As a secluded nudist beach, it offers an unspoiled, natural retreat far away from the crowds—perfect for those seeking true tranquility.',
        'discoverPage.beaches.s4Title': 'Playa del Duque',
        'discoverPage.beaches.s4Body': 'One of the most prestigious beaches in Tenerife, Playa del Duque features fine golden sand, crystal-clear calm waters, and upscale beachfront restaurants. It\'s a 10-minute drive or a pleasant coastal walk. Sun loungers and parasols are available for rent.',
        'discoverPage.beaches.s5Title': 'Playa de Fañabé & Playa de Torviscas',
        'discoverPage.beaches.s5Body': 'These neighbouring beaches offer great facilities including water sports, beach bars, and lifeguards on duty year-round. The promenade connecting them is perfect for evening strolls. Both are Blue Flag certified, guaranteeing excellent water quality and services.',
        ...
        'discoverPage.food.s3Body': 'A highly recommended local favourite is Francis II, where you can enjoy fantastic authentic dishes in a welcoming atmosphere. Within walking distance, you\'ll also find excellent seafood restaurants along the Enramada beach. El rincón de Juan Carlos (Michelin-starred) is a short drive in Los Gigantes, and for rustic dining, try the guachinches in the wine regions.',
        ...
        'reviews.fallback1Name': 'Eleanorah Leal',
        'reviews.fallback1Text': 'Beautiful stay with all the comforts, and even a little more, the hosts take care of every detail. Spacious, located in a good area, with spectacular views and walks. An INCREDIBLE pool!!!! I will repeat without a doubt.',
        'reviews.fallback1Date': 'May 30, 2026',
        ...
        'faq.a4': 'The flat includes free WiFi, air conditioning, a fully equipped kitchen, Smart TV with Netflix, private terrace with ocean views, public street parking, washing machine, linens, towels, and access to the communal pool.',
        ...
        'faq.q10': 'Is Playa Paraíso a good area to stay in Tenerife?',
        ...
        'faq.q11': 'How far is Playa Paraíso from Tenerife South Airport?',
        'faq.a11': 'Playa Paraíso is approximately 25 km (20 minutes by car) from Tenerife South Airport (TFS). Taxis cost around \u20ac30\u201335, and we can arrange airport transfers on request. Rental cars are readily available at the airport.',
        'faq.q12': 'Can you book holiday apartments in Tenerife directly without Booking.com?',
        'faq.a12': 'Yes. Many holiday apartments in Tenerife, including Verónica\'s Flat, offer direct booking through their own website. Booking directly with the owner saves you 10\u201315% in platform commissions, gives you direct communication, and often comes with flexible cancellation terms.',
        'faq.q13': 'What is there to do near Playa Paraíso?',
        'faq.a13': 'Playa Paraíso offers sandy beaches (3-min walk), snorkelling, whale watching excursions, and is a short drive from Siam Park, Teide National Park, and the charming village of Masca. Local restaurants and a supermarket are within a 2-minute walk.',
        'faq.q14': 'What is the best time to visit Playa Paraíso, Tenerife?',
        'faq.a14': 'Tenerife enjoys year-round warm weather, making any month a good time to visit Playa Paraíso. Peak season (December\u2013March) is busiest. For lower prices and fewer crowds, consider April\u2013June or September\u2013November. Sea temperatures are warmest from August to October.',
        'faq.showMore': 'Show more questions',
        'faq.showLess': 'Show fewer questions',
        ...
        // ── Why Book Direct ──────────────────────────────────────
        'whyDirect.label': 'Why Book Direct',
        'whyDirect.title': 'Skip the Middleman, Keep More Money',
        'whyDirect.subtitle': 'Booking directly with the owner means lower prices, personal service, and zero platform commissions.',
        'whyDirect.col.direct': 'Book Direct',
        'whyDirect.col.platforms': 'Booking Platforms',
        'whyDirect.row.price': 'Price per night',
        'whyDirect.row.priceDirect': 'Best price',
        'whyDirect.row.pricePlatform': '+ 15–20% fees',
        'whyDirect.row.serviceFee': 'Service fee',
        'whyDirect.row.serviceFeeDirect': '€0',
        'whyDirect.row.serviceFeePlatform': 'Hidden in price',
        'whyDirect.row.contact': 'Host contact',
        'whyDirect.row.contactDirect': 'WhatsApp & email',
        'whyDirect.row.contactPlatform': 'Via platform only',
        'whyDirect.row.bestPrice': 'Best price guarantee',
        'whyDirect.row.localTips': 'Local tips & help',
        'whyDirect.cta': 'Book Direct — Best Price Guaranteed',
        ...
        'booking.childAgePlaceholder': 'Age…',
        'booking.ageUnit': 'yrs',
        'booking.childMinAge': 'Minimum age: 6 years',
        'booking.errorChildAge': 'Please enter each child\'s age (min. 6 years)',
        'booking.maxGuests': 'Maximum 3 guests total',
        ...
        'booking.phonePlaceholder': '600 123 456',
        'booking.errorPhone': 'Please enter your phone number',
        'booking.errorPhoneInvalid': 'Please enter a valid phone number',
        ...
        'booking.paypalTagBalance': 'Balance',
        'booking.paypalTagBank': 'Bank',
        'booking.paypalTagProtection': 'Protection',
        ...
        'booking.paymentLastMinuteNote': 'Since your check-in is within 14 days, full payment will be required instead of a deposit after we confirm your reservation.',
        ...
        'contact.phonePlaceholder': '600 123 456',
        ...
        'terms.s2.p2': 'The maximum occupancy is 3 guests (adults and children combined). Children must be at least 6 years old. All guests must be identified at the time of check-in as required by Spanish law (Parte de Viajeros). The person making the reservation must be at least 18 years old.',
        ...
        'terms.s6.li7': 'Children under the age of 6 are not permitted in the apartment.',
    ...
    es: {
        ...
        // Hero
        'hero.badge': 'Playa Paraíso · Tenerife',
        'hero.title': 'Apartamento Vacacional con Vistas al Mar en',
        'hero.titleHighlight': 'Playa Paraíso',
        'hero.subtitle': 'Despierta con atardeceres atlánticos, sol todo el año y la tranquilidad del sur de Tenerife. Reserva directamente con la propietaria\u00a0— ahorra hasta un 15% en comisiones. Sin intermediarios.',
        ...
        'amenity.parking': 'Aparcamiento Público',
        'amenity.parkingDesc': 'Hay aparcamiento público gratuito en la calle cerca del edificio.',
        ...
        'map.hint': '👆 Toca para explorar en el mapa',
        'map.explore': 'explorar →',
        'map.spots': 'lugares',
        'map.yourHome': 'Tu casa de vacaciones',
        'map.walkPool': '🚶 1 min a pie',
        'map.walkBeachGalgas': '🚶 3 min a pie',
        'map.walkBeachAjabo': '🚶 8 min a pie',
        'map.walkRestaurants': '🚶 1–5 min a pie',
        'map.walkSupermarket': '🚶 1 min a pie',
        'map.walkPharmacy': '🚶 3 min a pie',
        'map.medical': 'Centro Médico',
        'map.walkMedical': '🚶 5 min a pie',
        'map.shopping': 'Centro Comercial (Rosa)',
        'map.walkShopping': '🚶 5 min a pie',
        'map.walkAirport': '🚗 20 min en coche',
        'map.discoverBeach': 'Descubrir la playa',
        ...
        'discoverPage.viewOnMap': 'Ver en el mapa',
        ...
        'discoverPage.beaches.s1Title': 'Playa Las Galgas',
        'discoverPage.beaches.s1Body': 'Tu playa más cercana — a solo 3 minutos a pie del apartamento. Esta íntima cala volcánica está enmarcada por espectaculares formaciones de roca oscura y aguas cristalinas turquesas. Es la favorita de los locales por su ambiente tranquilo y sus impresionantes vistas al Atlántico. Las pozas rocosas son perfectas para el snorkel y los atardeceres aquí son inolvidables.',
        'discoverPage.beaches.s2Title': 'Playa de Ajabo',
        'discoverPage.beaches.s2Body': 'Una joya escondida a 8 minutos a pie. Esta cala recóndita de arena negra está rodeada de exuberante vegetación tropical y acantilados volcánicos. Sus aguas tranquilas y resguardadas son ideales para nadar y hacer snorkel. Raramente concurrida incluso en temporada alta — se siente como tu propia playa privada.',
        'discoverPage.beaches.s3Title': 'Playa nudista de Diego Hernández',
        'discoverPage.beaches.s3Body': 'Accesible a través de una pintoresca caminata, esta joya escondida es famosa por sus aguas turquesas cristalinas y arena blanca. Como playa nudista apartada, ofrece un refugio natural virgen lejos de las multitudes, perfecto para quienes buscan verdadera tranquilidad.',
        'discoverPage.beaches.s4Title': 'Playa del Duque',
        'discoverPage.beaches.s4Body': 'Una de las playas más prestigiosas de Tenerife, con arena dorada fina, aguas cristalinas y restaurantes de primera línea de playa. A 10 minutos en coche o un agradable paseo costero. Tumbonas y sombrillas disponibles para alquiler.',
        'discoverPage.beaches.s5Title': 'Playa de Fañabé y Playa de Torviscas',
        'discoverPage.beaches.s5Body': 'Estas playas vecinas ofrecen excelentes instalaciones: deportes acuáticos, chiringuitos y socorristas durante todo el año. El paseo marítimo que las conecta es perfecto para paseos vespertinos. Ambas tienen Bandera Azul, garantía de excelente calidad del agua.',
        ...
        'discoverPage.food.s3Body': 'Un gran favorito local que recomendamos encarecidamente es Francis II, donde podrás disfrutar de fantásticos platos auténticos en un ambiente acogedor. A distancia a pie también encontrarás excelentes restaurantes de mariscos en la playa de la Enramada. El rincón de Juan Carlos (estrella Michelin) está a pocos minutos en Los Gigantes, y para comida rústica, prueba los guachinches en las zonas vinícolas.',
        ...
        'reviews.fallback1Name': 'Eleanorah Leal',
        'reviews.fallback1Text': 'Estancia hermosa con todas las comodidades , y hasta un poco más , los anfitriones cuidan cada detalle. Espacioso, ubicado en buena zona, con vistas y paseos para caminar espectaculares. Una piscina INCREÍBLE!!!! Repetiré sin duda.',
        'reviews.fallback1Date': 'Mayo 30, 2026',
        ...
        'faq.a4': 'El apartamento incluye WiFi gratuito, aire acondicionado, cocina equipada, Smart TV con Netflix, terraza privada con vistas al mar, aparcamiento público en la calle, lavadora, ropa de cama, toallas y acceso a la piscina comunitaria.',
        ...
        'faq.q10': '¿Es Playa Paraíso una buena zona para alojarse en Tenerife?',
        'faq.a10': 'Sí. Playa Paraíso es una zona residencial tranquila en el municipio de Adeje, en la soleada costa suroeste de Tenerife. Ofrece playas de arena a pocos minutos a pie, temperaturas de 22\u201328\u00b0C todo el año y está a 20 minutos del aeropuerto. Ideal para parejas y familias que buscan una base tranquila con fácil acceso a Costa Adeje.',
        'faq.q11': '¿A qué distancia está Playa Paraíso del aeropuerto Tenerife Sur?',
        'faq.a11': 'Playa Paraíso está a unos 25 km (20 minutos en coche) del Aeropuerto Tenerife Sur (TFS). Los taxis cuestan unos \u20ac30\u201335, y podemos organizar traslados al aeropuerto a petición. Los coches de alquiler están disponibles en el aeropuerto.',
        'faq.q12': '¿Se pueden reservar apartamentos vacacionales en Tenerife directamente sin Booking.com?',
        'faq.a12': 'Sí. Muchos apartamentos vacacionales en Tenerife, incluido el apartamento de Verónica, ofrecen reserva directa a través de su propia web. Reservar directamente con el propietario te ahorra un 10\u201315% en comisiones de plataforma, te da comunicación directa y a menudo incluye condiciones de cancelación flexibles.',
        'faq.q13': '¿Qué se puede hacer cerca de Playa Paraíso?',
        'faq.a13': 'Playa Paraíso ofrece playas de arena (3 min a pie), snorkel, excursiones de avistamiento de ballenas, y está cerca de Siam Park, el Parque Nacional del Teide y el encantador pueblo de Masca. Restaurantes y supermercado están a 2 minutos a pie.',
        'faq.q14': '¿Cuál es la mejor época para visitar Playa Paraíso, Tenerife?',
        'faq.a14': 'Tenerife disfruta de buen tiempo todo el año, lo que hace que cualquier mes sea bueno para visitar Playa Paraíso. La temporada alta (diciembre\u2013marzo) es la más concurrida. Para precios más bajos y menos aglomeraciones, considera abril\u2013junio o septiembre\u2013noviembre. La temperatura del mar es más cálida de agosto a octubre.',
        'faq.showMore': 'Ver más preguntas',
        'faq.showLess': 'Ver menos preguntas',
        ...
        // ── Why Book Direct ──────────────────────────────────────
        'whyDirect.label': 'Por Qué Reservar Directo',
        'whyDirect.title': 'Sin Intermediarios, Más Ahorro',
        'whyDirect.subtitle': 'Reservar directamente con la propietaria significa precios más bajos, servicio personal y cero comisiones de plataforma.',
        'whyDirect.col.direct': 'Reserva Directa',
        'whyDirect.col.platforms': 'Plataformas de Reserva',
        'whyDirect.row.price': 'Precio por noche',
        'whyDirect.row.priceDirect': 'Mejor precio',
        'whyDirect.row.pricePlatform': '+ 15–20% tasas',
        'whyDirect.row.serviceFee': 'Comisión de servicio',
        'whyDirect.row.serviceFeeDirect': '\u20ac0',
        'whyDirect.row.serviceFeePlatform': 'Oculta en el precio',
        'whyDirect.row.contact': 'Contacto con anfitrión',
        'whyDirect.row.contactDirect': 'WhatsApp y email',
        'whyDirect.row.contactPlatform': 'Solo por plataforma',
        'whyDirect.row.bestPrice': 'Mejor precio garantizado',
        'whyDirect.row.localTips': 'Consejos locales',
        'whyDirect.cta': 'Reserva Directa — Mejor Precio Garantizado',
        ...
        'booking.child': 'Niño',
        'booking.childAge': 'Edad',
        'booking.childAgePlaceholder': 'Edad…',
        'booking.ageUnit': 'años',
        'booking.childMinAge': 'Edad mínima: 6 años',
        'booking.errorChildAge': 'Ingrese la edad de cada niño (mín. 6 años)',
        'booking.maxGuests': 'Máximo 3 huéspedes en total',
        ...
        'booking.errorPhoneInvalid': 'Por favor, introduce un número de teléfono válido',
        ...
        'booking.paypalTagBalance': 'Saldo',
        'booking.paypalTagBank': 'Banco',
        'booking.paypalTagProtection': 'Protección',
        ...
        'booking.paymentLastMinuteNote': 'Como tu llegada es en menos de 14 días, se requerirá el pago completo en lugar de un depósito después de confirmar tu reserva.',
        ...
        'terms.s2.p2': 'La capacidad máxima es de 3 huéspedes (adultos y niños combinados). Los niños deben tener al menos 6 años. Todos los huéspedes deben identificarse en el momento del check-in según la ley española (Parte de Viajeros). La persona que realiza la reserva debe ser mayor de 18 años.',
        ...
        'terms.s6.li7': 'No se permiten niños menores de 6 años en el apartamento.',
    ...
    cs: {
        ...
        // Hero
        'hero.badge': 'Playa Paraíso · Tenerife',
        'hero.title': 'Prázdninový Apartmán s Výhledem na Oceán v',
        'hero.titleHighlight': 'Playa Paraíso',
        'hero.subtitle': 'Probuďte se s atlantskými západy slunce, celoročním sluncem a klidem jižního Tenerife. Rezervujte přímo u majitelky\u00a0— ušetřete až 15 % na poplatcích. Žádné provize.',
        ...
        'amenity.parking': 'Veřejné Parkování',
        'amenity.parkingDesc': 'V blízkosti budovy je k dispozici bezplatné veřejné parkování na ulici.',
        ...
        'map.hint': '👆 Klikni pro zobrazení na mapě',
        'map.explore': 'prozkoumat →',
        'map.spots': 'míst',
        'map.yourHome': 'Tvůj prázdninový domov',
        'map.walkPool': '🚶 1 min pěšky',
        'map.walkBeachGalgas': '🚶 3 min pěšky',
        'map.walkBeachAjabo': '🚶 8 min pěšky',
        'map.walkRestaurants': '🚶 1–5 min pěšky',
        'map.walkSupermarket': '🚶 1 min pěšky',
        'map.walkPharmacy': '🚶 3 min pěšky',
        'map.medical': 'Lékařské centrum',
        'map.walkMedical': '🚶 5 min pěšky',
        'map.shopping': 'Obchodní centrum (Rosa)',
        'map.walkShopping': '🚶 5 min pěšky',
        'map.walkAirport': '🚗 20 min autem',
        'map.discoverBeach': 'Prozkoumat pláž',
        ...
        'discoverPage.viewOnMap': 'Zobrazit na mapě',
        ...
        'discoverPage.beaches.s1Title': 'Playa Las Galgas',
        'discoverPage.beaches.s1Body': 'Tvá nejbližší pláž — pouhé 3 minuty pěšky od apartmánu. Tato intimní vulkanická zátoka je lemována dramatickými tmavými skalními útvary a křišťálově čistou tyrkysovou vodou. Oblíbená u místních pro svou poklidnou atmosféru a úchvatné výhledy na Atlantik. Skalní tůňky jsou ideální pro šnorchlování a západy slunce zde jsou nezapomenutelné.',
        'discoverPage.beaches.s2Title': 'Playa de Ajabo',
        'discoverPage.beaches.s2Body': 'Skrytý klenot 8 minut pěšky. Tato odlehlá zátoka s černým pískem je obklopena bujnou tropickou vegetací a vulkanickými útesy. Klidné a chráněné vody jsou ideální pro plavání a šnorchlování. Zřídka přeplněná i v hlavní sezóně — působí jako vaše vlastní soukromá pláž.',
        'discoverPage.beaches.s3Title': 'Playa nudista de Diego Hernández',
        'discoverPage.beaches.s3Body': 'Tento skrytý klenot, přístupný po malebné turistické stezce, je známý svými křišťálově čistými tyrkysovými vodami a nedotčeným bílým pískem. Jako odlehlá nudistická pláž nabízí nedotčené přírodní útočiště daleko od davů – ideální pro ty, kteří hledají opravdový klid.',
        'discoverPage.beaches.s4Title': 'Playa del Duque',
        'discoverPage.beaches.s4Body': 'Jedna z nejprestižnějších pláží na Tenerife s jemným zlatým pískem, křišťálově čistou vodou a prvotřídními restauracemi na pláži. Je to 10 minut autem nebo příjemná pobřežní procházka. Lehátka a slunečníky jsou k pronájmu.',
        'discoverPage.beaches.s5Title': 'Playa de Fañabé a Playa de Torviscas',
        'discoverPage.beaches.s5Body': 'Tyto sousední pláže nabízejí skvělé vybavení: vodní sporty, plážové bary a plavčíky po celý rok. Promenáda, která je spojuje, je ideální pro večerní procházky. Obě mají certifikaci Modrá vlajka, tedy garanci vynikající kvality vody.',
        ...
        'discoverPage.food.s3Body': 'Velmi doporučovaným místním favoritem je Francis II, kde si můžete vychutnat fantastické autentické pokrmy v příjemné atmosféře. V docházkové vzdálenosti najdete také vynikající restaurace s mořskými plody na pláži Enramada. El rincón de Juan Carlos (Michelinská hvězda) je kousek jízdy v Los Gigantes a pro rustikální stolování zkuste guachinches ve vinařských oblastech.',
        ...
        'reviews.fallback1Name': 'Eleanorah Leal',
        'reviews.fallback1Text': 'Krásný pobyt se vším komfortem a ještě něčím navíc, hostitelé dbají na každý detail. Prostorné, v dobré lokalitě, s úžasnými výhledy a možnostmi procházek. Neskutečný BAZÉN!!!! Určitě se vrátím.',
        'reviews.fallback1Date': '30. května 2026',
        ...
        'faq.a4': 'Apartmán zahrnuje bezplatné WiFi, klimatizaci, plně vybavenou kuchyni, Smart TV s Netflixem, soukromou terasu s výhledem na moře, veřejné parkování na ulici, pračku, ložní prádlo, ručníky a přístup ke společnému bazénu.',
        ...
        'faq.q10': 'Je Playa Paraíso dobrá lokalita pro ubytování na Tenerife?',
        'faq.a10': 'Ano. Playa Paraíso je klidná rezidenční oblast v obci Adeje na slunečném jihozápadním pobřeží Tenerife. Nabízí písčité pláže v docházkové vzdálenosti, celoroční teploty 22\u201328 \u00b0C a je 20 minut od letiště. Ideální pro páry a rodiny hledající klidnou základnu s přístupem ke Costa Adeje.',
        'faq.q11': 'Jak daleko je Playa Paraíso od letiště Tenerife South?',
        'faq.a11': 'Playa Paraíso je přibližně 25 km (20 minut autem) od letiště Tenerife South (TFS). Taxík stojí asi \u20ac30\u201335 a můžeme zajistit transfer z letiště na požádání. Na letišti jsou k dispozici půjčovny aut.',
        'faq.q12': 'Lze rezervovat prázdninové apartmány na Tenerife přímo bez Booking.com?',
        'faq.a12': 'Ano. Mnoho prázdninových apartmánů na Tenerife, včetně Veronicina apartmánu, nabízí přímou rezervaci přes vlastní web. Rezervací přímo u majitele ušetříte 10\u201315 % na provizích platform, získáte přímou komunikaci a často i flexibilnější storno podmínky.',
        'faq.q13': 'Co se dá dělat v okolí Playa Paraíso?',
        'faq.a13': 'Playa Paraíso nabízí písčité pláže (3 min chůze), šnorchlování, výlety za velrybami a je nedaleko Siam Parku, národního parku Teide a kouzelnou vesnicí Masca. Restaurace a supermarket jsou 2 minuty pěšky.',
        'faq.q14': 'Kdy je nejlepší doba na návštěvu Playa Paraíso na Tenerife?',
        'faq.a14': 'Tenerife se těší celoročně teplému počasí, takže Playa Paraíso je ideální kdykoliv. Hlavní sezóna (prosinec\u2013březen) je nejrušnější. Pro nižší ceny a méně turistů zvažte duben\u2013červen nebo září\u2013listopad. Moře je nejteplejší od srpna do října.',
        'faq.showMore': 'Zobrazit více otázek',
        'faq.showLess': 'Zobrazit méně otázek',
        ...
        // ── Why Book Direct ──────────────────────────────────────
        'whyDirect.label': 'Proč Rezervovat Přímo',
        'whyDirect.title': 'Bez Prostředníků, Více Úspor',
        'whyDirect.subtitle': 'Rezervace přímo u majitelky znamená nižší ceny, osobní servis a nulové provize platforem.',
        'whyDirect.col.direct': 'Přímá Rezervace',
        'whyDirect.col.platforms': 'Rezervační Platformy',
        'whyDirect.row.price': 'Cena za noc',
        'whyDirect.row.priceDirect': 'Nejlepší cena',
        'whyDirect.row.pricePlatform': '+ 15–20 % poplatky',
        'whyDirect.row.serviceFee': 'Servisní poplatek',
        'whyDirect.row.serviceFeeDirect': '\u20ac0',
        'whyDirect.row.serviceFeePlatform': 'Skryt v ceně',
        'whyDirect.row.contact': 'Kontakt na hostitele',
        'whyDirect.row.contactDirect': 'WhatsApp a email',
        'whyDirect.row.contactPlatform': 'Pouze přes platformu',
        'whyDirect.row.bestPrice': 'Garance nejlepší ceny',
        'whyDirect.row.localTips': 'Místní tipy a pomoc',
        'whyDirect.cta': 'Rezervovat Přímo — Garance Nejlepší Ceny',
        ...
        'booking.child': 'Dítě',
        'booking.childAge': 'Věk',
        'booking.childAgePlaceholder': 'Věk…',
        'booking.ageUnit': 'let',
        'booking.childMinAge': 'Minimální věk: 6 let',
        'booking.errorChildAge': 'Zadejte věk každého dítěte (min. 6 let)',
        'booking.maxGuests': 'Maximálně 3 hosté celkem',
        ...
        'booking.errorPhoneInvalid': 'Prosím, zadejte platné telefonní číslo',
        ...
        'booking.paypalTagBalance': 'Zůstatek',
        'booking.paypalTagBank': 'Banka',
        'booking.paypalTagProtection': 'Ochrana',
        ...
        'booking.paymentLastMinuteNote': 'Protože je váš příjezd do 14 dnů, bude vyžadována plná platba místo zálohy po potvrzení vaší rezervace.',
        ...
        'terms.s2.p2': 'Maximální kapacita jsou 3 hosté (dospělí a děti dohromady). Děti musí mít alespoň 6 let. Všichni hosté musí být identifikováni při check-inu dle španělského zákona (Parte de Viajeros). Osoba provádějící rezervaci musí být starší 18 let.',
        ...
        'terms.s6.li7': 'Děti mladší 6 let nejsou v apartmánu povoleny.',
