...
const translations = {
    en: {
        ...
        'faq.a2': 'Simply select your dates and submit a booking request. We\'ll confirm availability within 24 hours. A 30% non-refundable deposit secures your reservation, with the remaining balance due 14 days before check-in.',
        'faq.q3': 'What is the cancellation policy?',
        'faq.a3': 'Cancellations more than 30 days before check-in receive a full refund (minus deposit). 15–30 days: 50% refund. Less than 15 days: no refund. The 30% deposit is non-refundable in all cases.',
    ...
    es: {
        ...
        'faq.a2': 'Simplemente selecciona tus fechas y envía una solicitud de reserva. Confirmaremos disponibilidad en 24 horas. Un depósito no reembolsable del 30% asegura tu reserva, con el saldo restante a pagar 14 días antes del check-in.',
        'faq.q3': '¿Cuál es la política de cancelación?',
        'faq.a3': 'Cancelaciones con más de 30 días de antelación: reembolso completo (menos depósito). 15–30 días: 50% de reembolso. Menos de 15 días: sin reembolso. El depósito del 30% no es reembolsable.',
