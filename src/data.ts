...
export const galleryItems: readonly GalleryItem[] = [
    { id: 1, src: '/gallery/Interior1-livingroom.jpg', alt: 'Modern living room with Atlantic ocean view in Playa Paraíso holiday apartment', category: 'interior' },
    ...
    { id: 17, src: '/gallery/Interior7-bedroom.jpg', alt: 'Spacious bedroom with king-size bed in Tenerife vacation rental', category: 'interior' },
    ...
    { id: 4, src: '/gallery/Terace1.jpg', alt: 'Private terrace with panoramic sea view — holiday apartment Playa Paraíso, Tenerife', category: 'terrace' },
    ...
    { id: 5, src: '/gallery/Pool1.jpg', alt: 'Communal swimming pool at holiday apartment complex in Playa Paraíso', category: 'pool' },
